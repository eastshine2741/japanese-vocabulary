 ...
 *
 * surface/dictionaryForm are deliberately NOT part of this response. Echoing them doubled the output
 ...
 * surface, and dictionaryForm was only ever compared against the value the request supplied.
 */
