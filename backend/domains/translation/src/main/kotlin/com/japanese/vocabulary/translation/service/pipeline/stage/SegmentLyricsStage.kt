...
class SegmentLyricsStage(
     ...
     * Japanese in it is the same case from the other side: `あいうぉんちゅー` came back with headword
     * `I want you`, and jisho cannot answer a latin headword any more than a katakana coinage.
     */
