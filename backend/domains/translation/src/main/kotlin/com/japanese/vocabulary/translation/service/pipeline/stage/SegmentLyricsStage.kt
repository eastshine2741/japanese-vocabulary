...
class SegmentLyricsStage(
     ...
     * no Japanese in it: an English ad-lib sung in hiragana (`あいうぉんちゅー`) has no Japanese
     * dictionary form for the model to give, so it answers with the English phrase (`I want you`),
     * which a Japanese dictionary can never hold.
     */
