...
class SegmentLyricsStage(
     ...
     * Japanese in it is exempt for the same reason: `あいうぉんちゅー` is the same loanword written in
     * hiragana, and the model answers it with the English it transliterates (`I want you`), which no
     * Japanese dictionary holds either.
     */
