...
class SegmentLyricsStage(
     ...
     * Japanese in it is exempt for the same reason: `あいうぉんちゅー` came back as `I want you`, and
     * jisho cannot answer a latin headword whatever script the surface was sung in.
     */
