...
class SegmentLyricsStage(
     ...
     * no Japanese in it: the same loanword sung in hiragana (`あいうぉんちゅー`) comes back with the
     * English it transcribes as its headword (`I want you`), which no Japanese dictionary can answer.
     */
