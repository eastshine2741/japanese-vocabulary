...
class SegmentLyricsStage(
     ...
     * Japanese in it is exempt for the same reason: `あいうぉんちゅー` is an English ad-lib sung in
     * hiragana, and the model gave `I want you` back as its headword — jisho headwords are Japanese,
     * so no retry can answer that either.
     */
