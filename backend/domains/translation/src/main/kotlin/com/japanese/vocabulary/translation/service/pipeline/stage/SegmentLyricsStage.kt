...
class SegmentLyricsStage(
     ...
     * says so by answering the headword `I want you` — a Japanese dictionary cannot hold that either.
     */
    private suspend fun headwordMisses(
        ...
        val checkable = tokensByIndex.values
            ...
            .filterNot { it.headword.isNotBlank() && !JapaneseText.containsJapanese(it.headword) }
