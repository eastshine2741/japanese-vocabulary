...
class SegmentLyricsStage(
     ...
     * Japanese in it is exempt for the same reason: an English phrase sung in kana
     * (`あいうぉんちゅー` → `I want you`) is a surface the line holds, but jisho indexes Japanese
     * headwords only, so the lookup can never answer and the retry can never help.
     */
