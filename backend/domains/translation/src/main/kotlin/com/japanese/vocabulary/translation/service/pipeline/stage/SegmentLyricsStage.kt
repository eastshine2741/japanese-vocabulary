...
class SegmentLyricsStage(
     ...
     * Japanese in it is exempt for the same reason: `あいうぉんちゅー` is "I want you" sung in hiragana,
     * and the model keeps the English as the headword, which a Japanese dictionary can never answer.
     */
