export const TOS_URL = 'https://eastshine2741.github.io/kotonoha-legal/terms';
export const PRIVACY_URL = 'https://eastshine2741.github.io/kotonoha-legal/privacy';
...
export function buildReportMailto(opts?: { songId?: number; songTitle?: string; artist?: string }): string {
  const subjectParts = ['[Kotonoha] 권리자 신고'];
