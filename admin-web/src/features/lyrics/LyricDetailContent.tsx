...
export function LyricDetailContent({ lyric }: { lyric: LyricDetail }) {
  ...
  return (
    <>
      <DetailGrid>
        <DetailItem label="Lyric ID" value={lyric.id} />
      ...
      <section className="mt-6 border-y border-[#d9e1ea] bg-white">
        <div className="flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h3 className="text-sm font-semibold text-[#18212f]">Content export</h3>
      ...
      <section className="mt-6">
        <div className="mb-3 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h3 className="text-sm font-semibold text-[#18212f]">Analyzed lyrics</h3>
